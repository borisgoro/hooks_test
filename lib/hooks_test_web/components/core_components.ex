defmodule HooksTestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HooksTestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HooksTestWeb.Gettext, "errors", msg, opts)
    end
  end
